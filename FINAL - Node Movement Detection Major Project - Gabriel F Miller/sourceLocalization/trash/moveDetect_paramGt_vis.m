...
they originated. The purpose is to see the performance of the 
probability of failure as indicated by the MRF based movement detector with
respect to the ROC curve for parameters of the latent state priors chosen 
via the average maximum likelihood result for varying T60s or specified
results for each T60.
 
To simulate results, run moveDetect_paramGt_sim.m
%}
