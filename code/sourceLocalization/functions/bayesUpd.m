function [mu, cov, Q_t] = bayesUpd(nL, numArrays, RTF_test, scales, p_hat_t, kern_typ, k_t_new, Q_t, mu, cov, vari)
    ...
    Q_t = horzcat(vertcat(Q_t,zeros(1,nL)),zeros(nL+1,1)) + (1/norm_new)*[q_t_new;-1]*[q_t_new;-1]';
